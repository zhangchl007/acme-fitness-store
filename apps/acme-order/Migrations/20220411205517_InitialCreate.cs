        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date = table.Column<DateTime>(nullable: true, defaultValue: new DateTime(2022, 4, 11, 20, 55, 17, 183, DateTimeKind.Utc).AddTicks(7920)),
                    ...
                    cart = table.Column<List<Cart>>(type: "json", nullable: true)
                },
                constraints: table =>
                {
